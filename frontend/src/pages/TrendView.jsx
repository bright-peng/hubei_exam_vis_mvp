...
export default function TrendView() {
  ...
  const [filters, setFilters] = useState({ cities: [] })
      ...
      <div className="trend-stats">
        <div className="glass-card stat-mini">
          ...
          <div className="stat-content">
            <div className="stat-value">{trendData[trendData.length - 1]?.applicants?.toLocaleString() || 0}</div>
        ...
        <div className="glass-card stat-mini">
          ...
          <div className="stat-content">
            <div className="stat-value">
              {trendData.length > 1
                ? (trendData[trendData.length - 1]?.applicants - trendData[trendData.length - 2]?.applicants)?.toLocaleString()
                : 0}
            </div>
        ...
        <div className="glass-card stat-mini">
          <div className="stat-icon">✅</div>
          <div className="stat-content">
            <div className="stat-value">{trendData[trendData.length - 1]?.passed?.toLocaleString() || 0}</div>
            ...
            <tbody>
              {[...trendData].reverse().map((row, idx) => {
                ...
                const passRate = row.applicants > 0
                  ? ((row.passed / row.applicants) * 100).toFixed(1)
                  : 0
